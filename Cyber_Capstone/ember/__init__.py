...
if __name__ == "__main__":
    data_dir = "C:/Users/aj/Documents/antivirus-ml/ember-master/ember"

    print("Step 1: Creating vectorized features...")
    ...
    best_params = optimize_model(data_dir)
    print(f"Best Parameters: {best_params}")

    print("Step 4: Training final model...")
    model = train_model(data_dir, best_params)
